...
public class ViewConfig
{
    ...
    static bool IsDemolition =>
        Runtime.GameTitle.Contains("Demolition", StringComparison.Ordinal);
    ...
    public void ApplyGraphicsPreset(string preset)
    {
        ...
        PreciseCulling = !original;
        PerspectiveCorrectColors = !original;
        // Demolition's world renderer deliberately layers detailed terrain,
        // targeting effects, and exhaust through its 4096-bucket ordering
        // table. A modern Z buffer lets the earlier coarse terrain pass hide
        // those later packets, so preserve the retail painter order.
        EnhancedDepthBuffer = !original && !IsDemolition;
        TrueColor = !original;
        ...
        // the contour reconstruction was tuned against V8:2's sprite set.
        EnhancedParticles = !original && !IsDemolition;
        VectorFonts = !original;
        VectorIcons = !original;
        ExtendedDrawDistance = !original;
        EnhancedFog = !original;
